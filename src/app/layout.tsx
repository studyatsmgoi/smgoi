...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://smgoi.com",
    siteName: "Sankat Mochan Group Of Institutions",
    images: [
      {
        url: "https://smgoi.com/backseo1.png",
        width: 800,
        height: 600,
      },
      {
        url: "https://smgoi.com/backseo2.png",
        width: 1800,
        height: 1600,
        alt: "Sankat Mochan Group Of Institutions Profile Logo",
      },
      {
        url: "https://smgoi.com/backseo.png",
        width: 300,
        height: 200,
      },
    ],
