        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20">
            ...
            <p className="lg:w-1/2 w-full leading-relaxed text-white text-opacity-90">
              Welcome to the Department of English at Sankat Mochan Group of
              Institutions, where we strive to cultivate a rich and dynamic
              learning environment for our students. Our commitment is to
              empower individuals with the skills and knowledge necessary for
              effective communication, critical thinking, and a deep
            ...
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
                <TeacherProfile
                  name="Akanksha"
                  role="Assistant Teacher"
                  image="/departments/english/akanksha.webp"
                  bio="Akanksha, accomplished English Assistant Teacher at Sankat Mochan Group Of Institutions, nurtures language skills and fosters literary appreciation in students."
                />
              </div>
            </div>
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
                <TeacherProfile
                  name="Khushi Singh"
                  role="Assistant Teacher"
                  image="/departments/english/khushi.webp"
